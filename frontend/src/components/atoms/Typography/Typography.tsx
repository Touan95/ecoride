  ...
  return (
    <CustomTag
      ...
      className={clsxm(
        ...
        customClassName,
        [
          variant === 'title' && 'font-medium md:text-[38px] text-3xl',
          variant === 'h1' && 'font-900 md:text-3xl text-xl',
          variant === 'h2' && 'font-900 md:text-2xl text-xl',
          variant === 'h3' && 'font-900 md:text-xl text-lg',
          variant === 'h4' && 'font-900 md:text-lg text-base',
          variant === 'h5' && 'font-900 md:text-base text-sm',
          variant === 'cardTitle' && 'md:text-xl font-semibold text-lg',
          variant === 'cardTitleSm' && 'md:text-base font-semibold text-sm',
          variant === 'paragraph' && 'font-500 md:text-base text-sm',
          variant === 'small' && 'md:text-sm text-xs',
          variant === 'extraSmall' && 'md:text-[10px] text-xs'
        ],
