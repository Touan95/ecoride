...
export class Init1739628587710 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ride" ("id" uuid NOT NULL, "reserved_seats" integer, "price" integer NOT NULL, "departure_date" TIMESTAMP NOT NULL, "arrival_date" TIMESTAMP NOT NULL, "duration" integer NOT NULL, "arrival_location" jsonb NOT NULL, "departure_location" jsonb NOT NULL, "status" "public"."ride_status_enum" NOT NULL DEFAULT 'upcoming', "driver_id" uuid, "car_id" uuid, CONSTRAINT "PK_f6bc30c4dd875370bafcb54af1b" PRIMARY KEY ("id"))`);
