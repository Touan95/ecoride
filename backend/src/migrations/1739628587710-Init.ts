...
export class Init1739628587710 implements MigrationInterface {
  name = 'Init1739628587710';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ride" ("id" uuid NOT NULL, "reserved_seats" integer, "price" integer NOT NULL, "departure_date" TIMESTAMP NOT NULL, "arrival_date" TIMESTAMP NOT NULL, "duration" integer NOT NULL, "arrival_location" jsonb NOT NULL, "departure_location" jsonb NOT NULL, "status" "public"."ride_status_enum" NOT NULL DEFAULT 'upcoming', "driver_id" uuid, "car_id" uuid, CONSTRAINT "PK_f6bc30c4dd875370bafcb54af1b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transaction_transaction_type_enum" AS ENUM('earned', 'spent')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "technology" ("id" SERIAL NOT NULL, "display_name" character varying(256) NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_89f217a9ebf9b4bc1a0d74883ec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "ride_passenger" ("ride_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_20dc1d6fb272eea17e4fed0b3d7" PRIMARY KEY ("ride_id", "user_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1260fb2aa90e44aa11426e5fb2" ON "ride_passenger" ("ride_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d9bccd61cec12b7e0161853132" ON "ride_passenger" ("user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_df0ef3a4f4ca16431aa5d343c38" FOREIGN KEY ("payer_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_7f8c694d3eb02b8fc73d85b0330" FOREIGN KEY ("receiver_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ride_passenger" ADD CONSTRAINT "FK_1260fb2aa90e44aa11426e5fb26" FOREIGN KEY ("ride_id") REFERENCES "ride"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "ride_passenger" ADD CONSTRAINT "FK_d9bccd61cec12b7e01618531321" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP CONSTRAINT "FK_df0ef3a4f4ca16431aa5d343c38"`,
    );
    await queryRunner.query(
